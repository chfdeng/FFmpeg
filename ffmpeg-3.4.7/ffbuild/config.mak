...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/zero/android/workspace/ffmpeg/libs/ffmpeg-x264-fdkaac-merge/armeabi-v7a --enable-cross-compile --disable-runtime-cpudetect --disable-asm --arch=armeabi-v7a --target-os=android --cc=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --disable-stripping --nm=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --sysroot=/home/zero/android/android-ndk-r12b/platforms/android-21/arch-arm --extra-cflags='-I/home/zero/android/workspace/ffmpeg/libs/libx264/armeabi-v7a/include  -I/home/zero/android/workspace/ffmpeg/libs/libfdk-aac/armeabi-v7a/include ' --extra-ldflags='-L/home/zero/android/workspace/ffmpeg/libs/libfdk-aac/armeabi-v7a/lib -L/home/zero/android/workspace/ffmpeg/libs/libx264/armeabi-v7a/lib' --enable-gpl --enable-nonfree --disable-shared --enable-static --enable-version3 --enable-pthreads --enable-small --disable-vda --disable-iconv --enable-libx264 --enable-neon --enable-yasm --enable-libfdk_aac --disable-encoders --enable-encoder=libx264 --enable-encoder=mpeg4 --enable-encoder=libfdk_aac --enable-encoder=mjpeg --enable-encoder=png --enable-nonfree --enable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=avi --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=png --disable-demuxers --enable-demuxer=image2 --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=avi --enable-demuxer=mpc --enable-demuxer=mpegts --enable-demuxer=mov --enable-demuxer=rtsp --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --enable-protocols --enable-zlib --enable-avfilter --enable-avresample --enable-postproc --enable-avdevice --disable-outdevs --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-ffserver --disable-debug --disable-symver --disable-stripping --extra-cflags='-DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300   -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID  ' --extra-ldflags='  '
...
ARCH=c
INTRINSICS=none
CC=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
CXX=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-g++
AS=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LD=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=echo skipping strip
STRIPTYPE=
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/home/zero/android/android-ndk-r12b/platforms/android-21/arch-arm -isysroot /home/zero/android/android-ndk-r12b/platforms/android-21/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I/home/zero/android/workspace/ffmpeg/libs/libx264/armeabi-v7a/include -I/home/zero/android/workspace/ffmpeg/libs/libfdk-aac/armeabi-v7a/include -DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -march=armv7-a -std=c11 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/home/zero/android/workspace/ffmpeg/libs/libx264/armeabi-v7a/include -I/home/zero/android/workspace/ffmpeg/libs/libfdk-aac/armeabi-v7a/include -DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -march=armv7-a -fPIC
...
LD_PATH=-L
DLLTOOL=
WINDRES=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/home/zero/android/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/zero/android/workspace/ffmpeg/libs/libfdk-aac/armeabi-v7a/lib -L/home/zero/android/workspace/ffmpeg/libs/libx264/armeabi-v7a/lib   --sysroot=/home/zero/android/android-ndk-r12b/platforms/android-21/arch-arm -isysroot /home/zero/android/android-ndk-r12b/platforms/android-21/arch-arm -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lx264 -lfdk-aac -lm  -lz -pthread -pthread 
...
avdevice_FFLIBS=avfilter avresample swscale postproc swresample avformat avcodec avutil
avfilter_FFLIBS=avresample swscale postproc swresample avformat avcodec avutil
